...
<html>
<head>
    <title>Udana rejestracja nowego użytkownika</title>
    <meta charset="UTF-8">
...
<div class="limiter">
    <div class="custom1" style="background-image: url('/css/images/construction.jpg');">
        ...
        <div class="custom5">
        <p class="custom10">Rejestracja nowego użytkonika się powiodła. Wysłano maila z linkiem weryfikacyjnym.</p>
        <p class="custom10"><a class="custom10" href="/">>>Powrót do strony głównej<<</a></p>
        </div>
    </div>
</div>
