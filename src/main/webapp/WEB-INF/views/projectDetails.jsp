...
<head>
    <title>
        <c:out value="${currentProject.projectName}"></c:out>
    </title>
    <meta charset="UTF-8">
...
<div class="custom1" style="background-image: url('/css/images/construction.jpg');">
    ...
    <div class="custom5">
        <p class="custom6">Numer projektu: ${currentProject.projectNumber}</p>
        <p class="custom6">Nazwa projektu: ${currentProject.projectName}</p>
        <p class="custom6">Nazwa skrócona: ${currentProject.hash}</p>
        <p class="custom6">Zespół projektowy:
<%--            <c:forEach items="${currentProject.users}" var="user">--%>
<%--                ${user.}--%>
<%--            </c:forEach> </p>--%>
        <p class="custom6">Opis projektu: ${currentProject.description}</p>
    </div>
